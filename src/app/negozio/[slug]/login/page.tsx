...
export default function NegozioLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError('')
    try {
      const res = await fetch('/api/negozio-login', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      ...
      >
        <div>
          <h1 className="text-xl font-bold text-gray-900">Accesso negozio</h1>
